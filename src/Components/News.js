...
class News extends Component {
  constructor(){
    ...
    handlePrev = async ()=> {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=2a7b2fc51ab64ad49ccbf234cdc63c2e&page=${this.state.page-1}&pageSize=${this.state.pageSize}`;
    ...
    async componentDidMount(){
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=2a7b2fc51ab64ad49ccbf234cdc63c2e&${this.state.page}&pageSize=${this.state.pageSize}`;
        this.setState({loading: true})
        let data = await fetch(url);
        let newData = await data.json();
        console.log(newData);
